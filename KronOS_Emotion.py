...
gifs = ["bonk", "bug", "chainsaw", "chaos", "confused", "duck", "error", "execution", "food", "gym", "mad", "minigun", "pain", "potato", "rejected", "sane", "sheep", "slap", "squid", "summon", "useless"]
