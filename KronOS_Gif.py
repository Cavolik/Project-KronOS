...
gifs = ["bonk", "bug", "chainsaw", "chaos", "cloud", "confused", "duck", "error", "execution", "food", "gym", "mad", "minigun", "pain", "potato", "rejected", "sane", "sheep", "slap", "squid", "summon", "time", "triangle", "useless"]
