...
#TO DO: More gifs, Display face (animated?), Weather effect
import pygame
import os
import configparser
import requests
...
gifs = ["bonk", "bug", "chainsaw", "chaos", "cloud", "confused", "duck", "economy", "error", "execution", "food", "gym", "mad", "minigun", "pain", "potato", "rejected", "sane", "sheep", "slap", "squid", "summon", "time", "triangle", "tsundere", "useless"]
