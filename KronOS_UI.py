...
#TODO: More quotes, Display face (animated?), Death, AI, Personality modules
import time
import configparser
...
def play_animation(anim):
	...
	clip = VideoFileClip('/home/raspberry/gifs 2/' + anim)
	clip.preview()
...
while True:
	try:
		while choice == "Radio":	
			...
			song_display = config["RADIO"]["playing_ui"]
			...
			print (f"I'm currently playing {song_display}.")
			print (song_quote)
